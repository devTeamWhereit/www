...
<!--            <div class="panel-heading">회원가입</div>-->
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                    <textarea class="form-control" rows="7" readonly="readonly"><?php echo html_escape(element('member_register_policy1', $view)); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-12">
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                        <textarea class="form-control" rows="7" readonly="readonly"><?php echo html_escape(element('member_register_policy2', $view)); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-12">

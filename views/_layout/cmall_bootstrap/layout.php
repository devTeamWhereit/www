    ...
    <nav class="navbar navbar-default">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="<?php echo site_url('cmall'); ?>" class="navbar-brand" title="<?php echo html_escape($this->cbconfig->item('site_title'));?>"><?php echo $this->cmallconfig->item('cmall_name') ? html_escape($this->cmallconfig->item('cmall_name')) : $this->cmallconfig->item('site_logo'); ?></a>
            </div>

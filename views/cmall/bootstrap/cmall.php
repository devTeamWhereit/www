        ...
        <li class="col-xs-6 col-sm-6 col-md-3 col-lg-3 cmall-list-col">
            <div class="thumbnail">
                <a href="<?php echo cmall_item_url(element('cit_key', $item)); ?>" title="<?php echo html_escape(element('cit_name', $item)); ?>">
                    <img alt="<?php echo html_escape(element('cit_name', $item)); ?>" title="<?php echo html_escape(element('cit_name', $item)); ?>" src="<?php echo thumb_url('cmallitem', element('cit_file_1', $item), 232, 232); ?>">
                </a>
                ...
                <p class="cmall-txt"><?php echo element('category_all', $item); ?></p>

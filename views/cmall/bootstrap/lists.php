...
<div id="lists">
    ...
    <div class="cmall-list">
        <ul class="row">
            ...
            ?>
                <li class="col-xs-6 col-sm-6 col-md-3 col-lg-3 cmall-list-col">
                    <div class="thumbnail" >
...
<div class="row">
    <?php
    /**
    "_id" : ObjectId("5b9d328fe0f1d5242c4c10a7"),
    "Name" : "얌얌식빵",
    "new_address" : "서울 강남구 강남대로 358",
    "old_address" : "서울 강남구 역삼동 826-14 1층 얌얌식빵",
    "address_index" : "강남,강남역,논현",
    "phonenumber" : "02-565-4380",
     ...
     */
//    $mongo_data = $this->cimongo->get("store");
//    foreach($mongo_data->result_array() as $row) {
//        echo '<br>'.$row['Name'],$row['new_address'];
//    }

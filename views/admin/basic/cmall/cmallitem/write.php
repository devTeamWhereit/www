        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="collapse in" id="cmalltab3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">위치정보</label>
                        <div class="col-sm-10">
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control" name="cde_price_update[<?php echo html_escape(element('cde_id', $detail)); ?>]" value="<?php echo html_escape(element('cde_price', $detail) + 0); ?>" />원</td>
                ...
                <div class="collapse in" id="cmalltab4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo display_dhtml_editor('header_content', set_value('header_content', element('header_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = $this->cmallconfig->item('cmall_product_editor_type')); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">일반 하단 내용</label>
                        <div class="col-sm-10">
                            <?php echo display_dhtml_editor('footer_content', set_value('footer_content', element('footer_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = $this->cmallconfig->item('cmall_product_editor_type')); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">모바일 상단 내용</label>
                        <div class="col-sm-10">
                            <?php echo display_dhtml_editor('mobile_header_content', set_value('mobile_header_content', element('mobile_header_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = $this->cmallconfig->item('cmall_product_editor_type')); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">모바일 하단 내용</label>
                        <div class="col-sm-10">
                            <?php echo display_dhtml_editor('mobile_footer_content', set_value('mobile_footer_content', element('mobile_footer_content', element('data', $view))), $classname = 'form-control dhtmleditor', $is_dhtml_editor = true, $editor_type = $this->cmallconfig->item('cmall_product_editor_type')); ?>
                        </div>
                    </div>
                </div>
...
jQuery(function($) {
    $('#fadminwrite').validate({
        rules: {
            ...
            cit_content : {<?php echo ($this->cmallconfig->item('use_cmall_product_dhtml')) ? 'required_' . $this->cmallconfig->item('cmall_product_editor_type') : 'required'; ?> : true },
            cit_mobile_content : {<?php echo ($this->cmallconfig->item('use_cmall_product_dhtml')) ? 'valid_' . $this->cmallconfig->item('cmall_product_editor_type') : ''; ?> : true },
            header_content : { valid_<?php echo $this->cmallconfig->item('cmall_product_editor_type'); ?> : true },
            footer_content : { valid_<?php echo $this->cmallconfig->item('cmall_product_editor_type'); ?> : true },
            mobile_header_content : { valid_<?php echo $this->cmallconfig->item('cmall_product_editor_type'); ?> : true },
            mobile_footer_content : { valid_<?php echo $this->cmallconfig->item('cmall_product_editor_type'); ?> : true }
        },
